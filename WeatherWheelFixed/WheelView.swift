...
class WheelView: UIView {
    ...
    override func drawRect(rect: CGRect) {
        ...
        let wheelRect = CGRect(x: 2.0, y: 2.0, width: rect.width - 4.0, height: rect.height - 4.0)
        ...
        for i in 0...23 {
            ...
            if hourlyTemperatures != nil && hourlyTemperatures?.count > i {
                
                let temp = CGFloat(hourlyTemperatures![i].temperature!)
    ...
    override func layoutSubviews() {
        ...
        temperatureLabel.font = UIFont.systemFontOfSize(9.0)
        temperatureLabel.textColor = UIColor.whiteColor()
        temperatureLabel.text = "78°"
        temperatureLabel.sizeToFit()
        temperatureLabel.center = center
        addSubview(temperatureLabel)
    }
    
    func generateImage(hour: Int) -> UIImage {
